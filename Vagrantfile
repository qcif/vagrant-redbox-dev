...
Vagrant.configure(2) do |config|
  ...
  # SHELL
  config.vm.provision "file", source: "installDevTools.sh", destination: "installMaven.sh"
  config.vm.provision "shell", inline: "chmod +x installDevTools.sh; ./installMaven.sh"
end
